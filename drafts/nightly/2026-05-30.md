...
Generated: 2026-05-30T07:19:23.322Z
...
|---|---:|
| `generalist_baseline` | 53.17 |
| `blockchain_engineer_priors` | 51.92 |
...
| Variant | skills | yoe | hard_things | oss | schools | edu |
|---|---:|---:|---:|---:|---:|---|
| `baseline` | 8 | 8 | 7 | 0 | 5 | Bachelors |
| `depth-over-breadth` | 8 | 8 | 6 | 0 | 5 | Bachelors |

**Reindex — composite score on baseline traits, across weight sets:**

| Weight set | Composite score |
|---|---:|
| `generalist_baseline` | 41.33 |
| `blockchain_engineer_priors` | 44.58 |
...
| `hackathons` | +0.0200 |
| `open_source_contributions` | +0.0080 |
| `company_signals` | +0.0200 |
