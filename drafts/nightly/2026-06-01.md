...
Generated: 2026-06-01T08:12:53.459Z
...
|---|---:|---:|---:|---:|---:|---|
| `baseline` | 7 | 4 | 9 | 0 | 7 | Bachelors |
| `depth-over-breadth` | 7 | 4 | 8 | 0 | 7 | Bachelors |

**Reindex — composite score on baseline traits, across weight sets:**

| Weight set | Composite score |
|---|---:|
| `generalist_baseline` | 54.17 |
| `blockchain_engineer_priors` | 54.92 |
...
| Weight set | Composite score |
|---|---:|
| `generalist_baseline` | 11.83 |
| `blockchain_engineer_priors` | 7.33 |
