...
Generated: 2026-06-12T07:57:10.458Z
...
|---|---:|
| `generalist_baseline` | 55.67 |
| `blockchain_engineer_priors` | 55.92 |
...
| `depth-over-breadth` | 8 | 8 | 7 | 0 | 5 | Bachelors |
...
| Variant | skills | yoe | hard_things | oss | schools | edu |
|---|---:|---:|---:|---:|---:|---|
| `baseline` | 3 | 2 | 5 | 0 | 3 | None |
| `depth-over-breadth` | 3 | 2 | 0 | 0 | 3 | None |

**Reindex — composite score on baseline traits, across weight sets:**

| Weight set | Composite score |
|---|---:|
| `generalist_baseline` | 19.33 |
| `blockchain_engineer_priors` | 24.83 |
