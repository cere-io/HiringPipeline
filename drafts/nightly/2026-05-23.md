...
Generated: 2026-05-23T07:13:14.252Z
...
| Variant | skills | yoe | hard_things | oss | schools | edu |
|---|---:|---:|---:|---:|---:|---|
| `baseline` | 9 | 8 | 7 | 0 | 5 | Bachelors |
| `depth-over-breadth` | 10 | 8 | 6 | 0 | 5 | Bachelors |

**Reindex — composite score on baseline traits, across weight sets:**

| Weight set | Composite score |
|---|---:|
| `generalist_baseline` | 42.83 |
| `blockchain_engineer_priors` | 45.58 |
...
| Weight set | Composite score |
|---|---:|
| `generalist_baseline` | 30.83 |
| `blockchain_engineer_priors` | 21.83 |
...
| Weight set | Composite score |
|---|---:|
| `generalist_baseline` | 8.83 |
| `blockchain_engineer_priors` | 5.83 |
