            ...
            <div className="bg-slate-50 border-b border-slate-200 px-6 py-3 flex items-center gap-2 overflow-x-auto whitespace-nowrap hide-scrollbar">
              {latestCandidate && activeStep !== 1 && activeStep !== 2 && (
                <button onClick={() => { setLatestCandidate(null); setActiveStep(1); setGateDecision(null); setRejectionReasons([]); }}
                  className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-semibold bg-white border border-slate-300 text-slate-600 hover:bg-blue-50 hover:text-blue-600 hover:border-blue-300 transition-all shrink-0 mr-2">
